...
VERB98		TC	POSTJUMP
		...
		BANK 5
		BANK
VERB98B		CAF	V98DATA1	# LOAD THE FIRST 5 DIGITS INTO A
		TS	DSPTEM1		# STORE INTO DSPTEM1
		CAF	V98DATA2	# LOAD THE SECOND 5 DIGITS INTO A
		TS	DSPTEM1 + 1	# STORE INTO DSPTEM1 + 1
		CAF	V98DATA3	# LOAD THE THIRD 5 DIGITS INTO A
		...
		TC	ENDOFJOB
		TC	ENDOFJOB
V98DSP		VN	0625		# VERB 06, NOUN 25 CONSTANTS
